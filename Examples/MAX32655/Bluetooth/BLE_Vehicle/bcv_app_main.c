...
enum {
    ...
    BCV_APP_BT_CCC_IDX, /*! BCV characteristic */
    BCV_APP_NUM_CCC_IDX
};
...
static const attsCccSet_t bcvAppCccSet[BCV_APP_NUM_CCC_IDX] = {
    ...
    { BCV_BUTTON_CH_CCC_HDL, ATT_CLIENT_CFG_NOTIFY, DM_SEC_LEVEL_NONE } /* BCV_BUTTON_SM_CCC_IDX */
};
 ...
 */
/*************************************************************************************************/
static void bcvAppBtnCback(uint8_t btn)
{
    APP_TRACE_INFO1("bcvAppBtnCback; %d", btn);
    BcvSetFeatures(btn);
}
...
static void bcvAppProcMsg(dmEvt_t *pMsg)
{
    ...
    case DM_SEC_AUTH_REQ_IND:
        ...
        if (pMsg->authReq.oob) {
            ...
            /* TODO: Fill bcvAppOobCfg peerConfirm and peerRandom with value passed out of band */
...
void BcvAppStart(void)
{
    ...
    AppUiBtnRegister(bcvAppBtnCback);
