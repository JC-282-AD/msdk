...
const uint8_t svcBcvButtonUuid[ATT_128_UUID_LEN] = { ATT_UUID_BCV_BUTTON };
...
static const uint8_t bcvButtonValCh[] = { ATT_PROP_READ | ATT_PROP_NOTIFY,
                                          UINT16_TO_BYTES(BCV_BUTTON_HDL), ATT_UUID_BCV_BUTTON };
static const uint16_t bcvButtonLenCh = sizeof(bcvButtonValCh);
...
static uint8_t bcvButtonVal[] = { 0 };
static const uint16_t bcvButtonValLen = sizeof(bcvButtonVal);

static uint8_t bcvButtonValChCcc[] = { UINT16_TO_BYTES(0x0000) };
static const uint16_t bcvButtonLenValChCcc = sizeof(bcvButtonValChCcc);
...
static const attsAttr_t bcvList[] = {
    ...
    { attChUuid, (uint8_t *)bcvButtonValCh, (uint16_t *)&bcvButtonLenCh, sizeof(bcvButtonValCh), 0,
      BCV_SEC_PERMIT_READ },
    /* Button characteristic value */
    { svcBcvButtonUuid, (uint8_t *)bcvButtonVal, (uint16_t *)&bcvButtonValLen, sizeof(bcvButtonVal),
      0, BCV_SEC_PERMIT_READ },
    /*Button characteristic value descriptor*/
    { attCliChCfgUuid, (uint8_t *)bcvButtonValChCcc, (uint16_t *)&bcvButtonLenValChCcc,
      sizeof(bcvButtonValChCcc), ATTS_SET_CCC, (ATTS_PERMIT_READ | SVC_SEC_PERMIT_WRITE) },
